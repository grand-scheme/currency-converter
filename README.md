...
**Code:** 
> if (${"Error Test 1"} === true && ${"Error Test 2"} === true) {\
> makeCall();\
> }
...
> For this project, you will need your own personal API key from [ExchangeRate-Api](https://www.exchangerate-api.com/). They are free to acquire and free to use; you only need to sign up for one. 
> Your key will become activated once you verify your email address.
> Once you receive your activated key, keep it handy. You will need it in a few minutes.
>
> **Note**: You will also need to have [Node](https://nodejs.org/en/download/) installed on your machine prior to downloading this project.
...
1. Once you have the project locally stored, navigate to its main directory in your terminal of choice or in your file explorer. By default, this is `currency-converter`. You will need to create and write to a new file.

2. Create file **.env** and open this in your text editor of choice. In this file, input the following text:\
    ```API_KEY=```\
Copy the API key you received from ExchangeRate-API and paste it onto this line after the `=` . It will likely be a string of 24 alphanumeric characters. Save and close this file.

3. If you did not use your terminal to create the .env file above, please navigate to `currency-converter` in your console. You will need to run some command-line codes. 
...
6. Check your browser for this project's containing website.
-------------------------------
